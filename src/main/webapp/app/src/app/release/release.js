angular.module( 'ngBoilerplate.release', [
    ...
    .controller("ReleaseSearchCtrl", function($scope, releaseService, $log) {
        ...
        $scope.getMaReleaseTowns = function() {
            $scope.loadingTowns = true;

            // Get the $promise from the service to fetch all the release towns
            releaseService.getMaReleaseTowns().then(
                function(data) {
                    $scope.towns = data;
                    loadingTowns = false;
                },
        ...
        $scope.towns = [];
        releaseService.getMaReleaseTowns();
